sap.ui.define([
	...
	return BaseObject.extend("com.sap.build.standard.inventoryDashboard.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias com.sap.build.standard.inventoryDashboard.model.ListSelector
		 */
		 ...
		 * @return {com.sap.build.standard.inventoryDashboard.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
